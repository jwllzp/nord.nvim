...
function M.setup(opts)
	...
	hi("Boolean", { fg = c.frost.purple, bold=true })
	...
	hi("Conditional", { fg = c.frost.purple, bold=true })
	hi("Repeat", { fg = c.frost.purple, bold=true })
	hi("Label", { fg = c.snow.dark })
	hi("Operator", { fg = c.frost.purple })
	hi("Keyword", { fg = c.frost.purple, bold=true })
	...
	hi("Special", { fg = c.frost.purple, bold=true })
