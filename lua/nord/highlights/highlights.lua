...
function M.setup(opts)
	...
	hi("Conditional", { fg = c.frost.purple, style="bold" })
	hi("Repeat", { fg = c.frost.purple, style="bold" })
	hi("Label", { fg = c.snow.dark })
	hi("Operator", { fg = c.frost.purple })
	hi("Keyword", { fg = c.frost.purple, style="bold" })
	hi("Exception", { fg = c.frost.purple, style="bold" })
